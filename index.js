...
import day16 from './challenges/day16/day16.js';
...
if (!filter) {
  ...
  challengeWrapper(15, { 1: day15.challengeOne, 2: day15.challengeTwo });
}

if (!filter || filter === 'latest') {
  challengeWrapper(16, { 1: day16.challengeOne, 2: day16.challengeTwo });
} else {
